    ...
    public static ArrayList<Video> expertsVideos = new ArrayList<Video>() {
        {
            ...
            add(new Video(1, "من تقديم الاخصائية مريم وحمان - ABA - أشناهوا", "ZIS3HAkLjdw", "3 دقائق و 23 ثانية"));
            add(new Video(1, "ABA الأخصائية النفسية - مريم وحمان - كيفاش نعاون ولدي باعتماد تقنيات ل", "-tx3iH7nNzs", "5 دقائق و 36 ثانية"));
            add(new Video(1, "من تقديم الاخصائية مريم وحمان - ABA - أشناهوا 2", "ck2A_04lAWs", "0 دقائق و 57 ثانية"));
